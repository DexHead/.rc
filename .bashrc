...
# own aliases jump-to
alias vdp='cd /media/truecrypt6/repository/vdp-src' # local vdp
alias script='cd ~/Script' # script folder
alias vit='vi -t' #vi mit tagsuche
...
alias autostart='gnome-session-properties'	# autostart programme add-del-edit
